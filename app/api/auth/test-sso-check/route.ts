...
/**
 * Pre-check endpoint for the test-sso login flow.
 *
 ...
 * found", "account inactive", and "invalid role". This endpoint performs the
 * same checks as authorize() and returns a specific error code so the UI can
