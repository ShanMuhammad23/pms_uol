                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {value}
                            {isAssigned ? (
                              <span className="ml-2 inline-flex items-center rounded-md bg-violet-100 px-1.5 py-0.5 text-[10px] font-semibold text-violet-700 dark:bg-violet-900/30 dark:text-violet-300">
                                Direct Score
                              </span>
                            ) : null}
                          </span>
