...
function StatusBadge({ status }: { status: string | null }) {
  ...
  return (
    ...
    >
      ...
      {isActive ? "Active Employment" : status || "Unknown"}
    </span>
  );
}
    ...
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            SAP personnel record — verified university employment data
          </p>
        </div>
      ...
      >
        ...
        <ProfileField
          ...
          value={profile.employmentStatus === "1" ? "Active" : profile.employmentStatus || "—"}
      ...
      >
        Data sourced from SAP HR module. Contact IT Support for corrections.
      </motion.p>
    </div>
  );
}